...
export const useClassStore = create<ClassStore>((set, get) => ({
  ...
  addActivityScore: async (classId, studentPerformanceId, score) => {
    try {
      const response = await axios.post(
        `${API_URL}/classes/${classId}/studentsPerformance/${studentPerformanceId}/activityScores`,
        { score }
      )
  ...
  addActivityPoints: async (classId, studentPerformanceId, points) => {
    try {
      const response = await axios.post(
        `${API_URL}/classes/${classId}/studentsPerformance/${studentPerformanceId}/activityPoints`,
        { points }
      )
  ...
  addLoudnessWarning: async (classId, studentPerformanceId) => {
    try {
      const response = await axios.post(
        `${API_URL}/classes/${classId}/studentsPerformance/${studentPerformanceId}/loudnessWarnings`
      )
  ...
  addMissingHomework: async (classId, studentPerformanceId) => {
    try {
      const response = await axios.post(
        `${API_URL}/classes/${classId}/studentsPerformance/${studentPerformanceId}/missingHomeworks`
      )
